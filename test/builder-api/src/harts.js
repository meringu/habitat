...
var data = fs.readFileSync('../fixtures/neurosis-testapp-0.1.3-20171205003213-x86_64-linux.hart');
    ...
    it('allows authenticated users to upload files', function(done) {
      request.post('/depot/pkgs/neurosis/testapp/0.1.3/20171205003213')
        ...
        .end(function(err, res) {
          expect(res.body).to.equal('/pkgs/neurosis/testapp/0.1.3/20171205003213/download');
          done(err);
        });
    });
